...
public class GenericUpdateQueryV1 implements SqlQuery {
    ...
    @Deprecated
    public GenericUpdateQueryV1(String tableName, String joinIdentifier) {
        m_tableName = tableName;
        m_joinIdentifier = joinIdentifier;
    }

    public GenericUpdateQueryV1(String tableName, boolean isNumberOfRowsCheck, int numberOfRowsChanged) {
        m_tableName = tableName;
        m_joinIdentifier = "";
    ...
    public String getSetString() {
        ...
        for (ColumnInterface column : m_updateColumns) {
            if (firstTime) {
                sb.append(", ");
            } else {
                firstTime = true;
    ...
    public int setSetParams(PreparedStatement psmt, int index) throws Exception {
        for (ColumnInterface column : m_updateColumns) {
            column.setInPreparedStatement(e, psmt, index++);
        }
        for (GenericFilter columnSetter : this.getGenericSetters()) {
